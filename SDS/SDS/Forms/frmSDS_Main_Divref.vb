...
Public Class frmSDS_Main_Divref
    ...
    Private Sub BackgroundWorker1_DoWork(ByVal sender As System.Object, ByVal e As System.ComponentModel.DoWorkEventArgs) Handles BackgroundWorker1.DoWork
        ...
        rExec("INSERT INTO DIVREF_S(KBCI_NO,LNAME,FNAME,MI,FEBTC_SA,DIVIDEND,REFUND,DEDUCTIONS,SDTIME,SDBBAL,SDEBAL) " & _
              "SELECT DR.KBCI_NO,DR.LNAME,DR.FNAME,DR.MI,FEBTC_SA,DR.DIVIDEND,DR.REFUND,ISNULL(DR.DEDUCTIONS,0),'" & Format(TimeOfDay, "HH:mm:ss") & "',SM.ACCTOBAL,SM.ACCTOBAL+((DR.DIVIDEND+DR.REFUND)-ISNULL(DR.DEDUCTIONS,0)) " & _
