Public Class ent_sdmaster
    ...
    Public Sub addData()
        ...
        _Binder = Nothing
    End Sub
    Public Sub getData(Optional ByVal filterStr As String = Nothing, Optional ByVal orderStr As String = Nothing)
        Dim _Binder As New Binder
    ...
    End Sub
End Class
Public Class ent_sdmaster_list
    Inherits List(Of ent_sdmaster)
    Public Sub New()
    End Sub
    Public Sub getDataList(Optional ByVal filterStr As String = Nothing, Optional ByVal orderStr As String = Nothing)
        Dim _Binder As New Binder
        _Binder.bind_SDMASTER_List(Me, filterStr, orderStr)
        _Binder = Nothing
    End Sub
    Public Overridable Shadows Sub Add(ByVal thisList As ent_sdmaster)
        MyBase.Add(thisList)
    End Sub
End Class
