...
Public Class rptMem_APayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptMem_APayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMem_APayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMem_APayment = New rptMem_APayment
        rpt.Site = Me.Site
        Return rpt
    End Function
