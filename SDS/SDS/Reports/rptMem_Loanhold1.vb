...
Public Class rptMem_Loanhold
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptMem_Loanhold.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptMem_Loanhold
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptMem_Loanhold = New rptMem_Loanhold
        rpt.Site = Me.Site
        Return rpt
    End Function
