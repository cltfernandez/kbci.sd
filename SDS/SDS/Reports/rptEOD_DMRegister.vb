...
Public Class rptEOD_DMRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptEOD_DMRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEOD_DMRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEOD_DMRegister = New rptEOD_DMRegister
        rpt.Site = Me.Site
        Return rpt
    End Function
