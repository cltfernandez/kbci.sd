...
Public Class rptEOD_CDRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptEOD_CDRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEOD_CDRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEOD_CDRegister = New rptEOD_CDRegister
        rpt.Site = Me.Site
        Return rpt
    End Function
