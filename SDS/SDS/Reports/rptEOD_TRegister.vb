...
Public Class rptEOD_TRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptEOD_TRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEOD_TRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEOD_TRegister = New rptEOD_TRegister
        rpt.Site = Me.Site
        Return rpt
    End Function
