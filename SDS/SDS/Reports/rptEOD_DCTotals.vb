...
Public Class rptEOD_DCTotals
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptEOD_DCTotals.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEOD_DCTotals
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEOD_DCTotals = New rptEOD_DCTotals
        rpt.Site = Me.Site
        Return rpt
    End Function
