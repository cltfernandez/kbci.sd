...
Public Class rptActivity_Log
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptActivity_Log.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptActivity_Log
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptActivity_Log = New rptActivity_Log
        rpt.Site = Me.Site
        Return rpt
    End Function
