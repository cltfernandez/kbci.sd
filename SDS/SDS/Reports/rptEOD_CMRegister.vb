...
Public Class rptEOD_CMRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptEOD_CMRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEOD_CMRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEOD_CMRegister = New rptEOD_CMRegister
        rpt.Site = Me.Site
        Return rpt
    End Function
