...
Public Class rptEOD_TListing
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptEOD_TListing.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEOD_TListing
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEOD_TListing = New rptEOD_TListing
        rpt.Site = Me.Site
        Return rpt
    End Function
