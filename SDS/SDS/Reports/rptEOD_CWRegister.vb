...
Public Class rptEOD_CWRegister
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptEOD_CWRegister.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEOD_CWRegister
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEOD_CWRegister = New rptEOD_CWRegister
        rpt.Site = Me.Site
        Return rpt
    End Function
