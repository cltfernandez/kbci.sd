...
Public Class rptEOD_ECorrect
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SDS.rptEOD_ECorrect.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptEOD_ECorrect
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptEOD_ECorrect = New rptEOD_ECorrect
        rpt.Site = Me.Site
        Return rpt
    End Function
