...
''' <summary>
'''DAO Class for table Extkbc
''' </summary>
''' <remarks>
'''Don't write code here
''' </remarks>

Public MustInherit Class _Extkbc
...
Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _IExtkbc.FillFromDataRecord
...
Private Property Manager As LUNA.ILunaBaseClassDAO(Of Extkbc)
    Get
        If _Mgr Is Nothing Then
            Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
            If _MgrType Is Nothing Then _MgrType = GetType(ExtkbcDAO)
            _Mgr = Activator.CreateInstance(_MgrType)
        End If
        Return _Mgr
    End Get
    Set(value As LUNA.ILunaBaseClassDAO(Of Extkbc))
        _Mgr = value
    End Set
End Property
...
Public Overridable Property EMPNO1() as single  Implements _IExtkbc.EMPNO1
    Get
	    Return _EMPNO1
    End Get
...
Public Overridable Property ACTYPE() as single  Implements _IExtkbc.ACTYPE
    Get
	    Return _ACTYPE
    End Get
    Set (byval value as single)
...
Public Overridable Property ACTCD1() as single  Implements _IExtkbc.ACTCD1
    Get
	    Return _ACTCD1
    End Get
    Set (byval value as single)
...
Public Overridable Property ACTCD2() as single  Implements _IExtkbc.ACTCD2
    Get
	    Return _ACTCD2
    End Get
    Set (byval value as single)
...
Public Overridable Property DATE7() as DateTime  Implements _IExtkbc.DATE7
    Get
	    Return _DATE7
    End Get
...
Public Overridable Property AMT7C() as single  Implements _IExtkbc.AMT7C
    Get
	    Return _AMT7C
    End Get
    Set (byval value as single)
...
Public Overridable Property CODE5() as single  Implements _IExtkbc.CODE5
    Get
	    Return _CODE5
    End Get
    Set (byval value as single)
...
#Region "Method"
''' <summary>
'''This method read an Extkbc from DB.
''' </summary>
''' <returns>
...
Public Overridable Function Read(Id As Integer) As Integer
    ...
    Try
	    Using Manager
	        Dim int As Extkbc = Manager.Read(Id)
                    _EMPNO1 = int.EMPNO1
                    _ACTYPE = int.ACTYPE
                    _ACTCD1 = int.ACTCD1
                    _ACTCD2 = int.ACTCD2
...
''' <summary>
'''This method save an Extkbc on DB.
''' </summary>
''' <returns>
