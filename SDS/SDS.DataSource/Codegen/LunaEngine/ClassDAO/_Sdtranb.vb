...
Public MustInherit Class _Sdtranb
	Inherits LUNA.LunaBaseClassEntity
    Implements _ISdtranb
...
Public Overridable Sub FillFromDataRecord(myRecord As IDataRecord) Implements _ISdtranb.FillFromDataRecord
     SDTRANB_ID = myRecord("SDTRANB_ID")
...
Private Property Manager As LUNA.ILunaBaseClassDAO(Of Sdtranb)
    Get
        If _Mgr Is Nothing Then
            Dim _MgrType As System.Type = LUNA.LunaContext.GetMgrTypeForEntity(Me.GetType)
            If _MgrType Is Nothing Then _MgrType = GetType(SdtranbDAO)
            _Mgr = Activator.CreateInstance(_MgrType)
        End If
        Return _Mgr
    End Get
    Set(value As LUNA.ILunaBaseClassDAO(Of Sdtranb))
        _Mgr = value
    End Set
End Property
...
Protected _SDTRANB_ID as Int64  = Nothing 
Public Overridable Property SDTRANB_ID() as Int64  Implements _ISdtranb.SDTRANB_ID
    Get
	    Return _SDTRANB_ID
    End Get
    Set (byval value as Int64)
	    If _SDTRANB_ID <> value Then
	        IsChanged = True
	        _SDTRANB_ID= value
	    End If
    End Set
...
Public Overridable Property ACCTNUM() as string  Implements _ISdtranb.ACCTNUM
    Get
	    Return _ACCTNUM
    End Get
...
Public Overridable Property TRANDATE() as DateTime  Implements _ISdtranb.TRANDATE
    Get
	    Return _TRANDATE
    End Get
...
Public Overridable Property TRANSEQ() as single  Implements _ISdtranb.TRANSEQ
    Get
	    Return _TRANSEQ
    End Get
...
Public Overridable Property TRANCODE() as string  Implements _ISdtranb.TRANCODE
    Get
	    Return _TRANCODE
    End Get
    Set (byval value as string)
...
Public Overridable Property TRANBBAL() as single  Implements _ISdtranb.TRANBBAL
    Get
	    Return _TRANBBAL
    End Get
    Set (byval value as single)
...
Public Overridable Property TRANDEB() as single  Implements _ISdtranb.TRANDEB
    Get
	    Return _TRANDEB
    End Get
    Set (byval value as single)
...
Public Overridable Property TRANCRE() as single  Implements _ISdtranb.TRANCRE
    Get
	    Return _TRANCRE
    End Get
    Set (byval value as single)
...
Public Overridable Property TRANEBAL() as single  Implements _ISdtranb.TRANEBAL
    Get
	    Return _TRANEBAL
    End Get
    Set (byval value as single)
...
Public Overridable Property CHKNUM() as string  Implements _ISdtranb.CHKNUM
    Get
	    Return _CHKNUM
    End Get
    Set (byval value as string)
...
Public Overridable Property CHKBANK() as string  Implements _ISdtranb.CHKBANK
    Get
	    Return _CHKBANK
    End Get
    Set (byval value as string)
...
Public Overridable Property CHKCODE() as string  Implements _ISdtranb.CHKCODE
    Get
	    Return _CHKCODE
    End Get
    Set (byval value as string)
...
Public Overridable Property ADD_DATE() as DateTime  Implements _ISdtranb.ADD_DATE
    Get
	    Return _ADD_DATE
    End Get
    Set (byval value as DateTime)
...
Public Overridable Property ADD_TIME() as string  Implements _ISdtranb.ADD_TIME
    Get
	    Return _ADD_TIME
    End Get
    Set (byval value as string)
...
Public Overridable Property USER() as string  Implements _ISdtranb.USER
    Get
	    Return _USER
    End Get
    Set (byval value as string)
...
Public Overridable Property OVERRIDE() as string  Implements _ISdtranb.OVERRIDE
    Get
	    Return _OVERRIDE
    End Get
    Set (byval value as string)
...
Public Overridable Property PPOSTED() as Boolean  Implements _ISdtranb.PPOSTED
    Get
	    Return _PPOSTED
    End Get
...
Public Overridable Property LPOSTED() as Boolean  Implements _ISdtranb.LPOSTED
    Get
	    Return _LPOSTED
    End Get
    Set (byval value as Boolean)
...
Public Overridable Property TRANOLD() as Boolean  Implements _ISdtranb.TRANOLD
    Get
	    Return _TRANOLD
    End Get
    Set (byval value as Boolean)
...
Public Overridable Property REVERSED() as Boolean  Implements _ISdtranb.REVERSED
    Get
	    Return _REVERSED
    End Get
    Set (byval value as Boolean)
...
#Region "Method"
''' <summary>
'''This method read an Sdtranb from DB.
''' </summary>
''' <returns>
...
Public Overridable Function Read(Id As Integer) As Integer
    ...
    Try
	    Using Manager
	        Dim int As Sdtranb = Manager.Read(Id)
                    _SDTRANB_ID = int.SDTRANB_ID
...
''' <summary>
'''This method save an Sdtranb on DB.
''' </summary>
''' <returns>
