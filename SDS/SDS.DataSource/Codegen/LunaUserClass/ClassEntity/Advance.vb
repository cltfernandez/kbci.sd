...
''' <summary>
'''Entity Class for table Advance
''' </summary>
''' <remarks>
...
Public Overrides Property ADVANCE_ID() as Int64
    Get
	    Return MyBase.ADVANCE_ID
    End Get
    Set (byval value as Int64)
        MyBase.ADVANCE_ID= value
    End Set
End property 
...
Public Overrides Function IsValid() As Boolean Implements IAdvance.IsValid
...
Public Overrides Function Read(Id As Integer) As Integer Implements IAdvance.Read
	Dim Ris as integer = MyBase.Read(Id)
    Return Ris
End Function

Public Overrides Function Save() As Integer Implements IAdvance.Save
