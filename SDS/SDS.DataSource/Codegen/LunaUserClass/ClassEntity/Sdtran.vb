...
Public Overrides Property SDTRAN_ID() as Int64
    Get
	    Return MyBase.SDTRAN_ID
    End Get
    Set (byval value as Int64)
        MyBase.SDTRAN_ID= value
    End Set
End property 
...
Public Overrides Function IsValid() As Boolean Implements ISdtran.IsValid
...
Public Overrides Function Read(Id As Integer) As Integer Implements ISdtran.Read
	Dim Ris as integer = MyBase.Read(Id)
    Return Ris
End Function

Public Overrides Function Save() As Integer Implements ISdtran.Save
