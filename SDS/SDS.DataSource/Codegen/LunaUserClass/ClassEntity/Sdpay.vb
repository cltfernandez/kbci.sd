...
Public Overrides Function IsValid() As Boolean Implements ISdpay.IsValid
...
Public Overrides Function Read(Id As Integer) As Integer Implements ISdpay.Read
	Dim Ris as integer = MyBase.Read(Id)
    Return Ris
End Function

Public Overrides Function Save() As Integer Implements ISdpay.Save
