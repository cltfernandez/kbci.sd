...
#Region "methods"
        ...
        Public Function ExecSP(ByVal storedProc As String, ByVal sqlParm As List(Of SqlParameter)) As Integer
            ...
            Return 0
        End Function
        Public Sub ExecuteCommand(ByVal cmdText As String, ByRef params As SqlParameterCollection)
            Using SqlConnection As New SqlConnection(defaultConnection.ConnectionString)
                Dim sqlcmd As New SqlCommand(cmdText, SqlConnection)
